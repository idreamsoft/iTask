...
define('iPHP_DB_NAME', 'itask'); // 数据库名
define('iPHP_DB_PREFIX','itask_');// 表名前缀, 同一数据库安装多个请修改此处
...
//----------------------------------------
define('iPHP_KEY','U4IKvcZtCxVJXs9Eysfnct0cltHjVscL');
define('iPHP_CHARSET','utf-8');
//---------------cookie设置-------------------------
define('iPHP_COOKIE_DOMAIN','');
define('iPHP_COOKIE_PATH','/');
define('iPHP_COOKIE_PRE','iTask');
define('iPHP_COOKIE_TIME','31536000');
...
//---------------模板------------------------
define('iPHP_TPL_VAR','iTask');//模板标签定义
//---------------DEBUG------------------------
